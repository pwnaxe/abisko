        ...
        <div className="bg-slate-50 pt-px sm:rounded-6xl">
          ...
          <div className="px-4 py-10 sm:px-10 sm:py-16 md:py-20 lg:px-20 lg:py-32"> */}
            ...
            <p className="mt-4 text-lg tracking-tight text-slate-700">
              I am a travel enthusiast and a nature lover. I have been to many places around the world, but Abisko is my favorite. It is a place that is not just a place, it is an experience. An experience that will take you to the edge of the world and back. It is a place where you can see the Northern Lights from the village, where you can hike, ski, fish, and explore the wilderness. It is a place where you can relax, unwind, and recharge. It is a place where you can be yourself.
            </p>
            <p className="mt-8">
              <Link
                href="#"
